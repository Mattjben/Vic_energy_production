...
# ACF and PACF
par(mfrow=c(1,2))
acf(Data_ts, main="Figure X: ACF plot of \ndaily Victorian electricity \nconsumption time series")
pacf(Data_ts, main="Figure X: PACF plot of \ndaily Victorian electricity \nconsumption time series")
...
adf.test(Data_ts)
```
The ADF test above shows the time series is stationary

```{r}
# Check the degree of normality 

qqnorm(y=Data_ts, main="Figure X: QQ plot of Victorian electricity consumption time series")
qqline(y=Data_ts, col=2, lwd=1, lty = 2)
```
