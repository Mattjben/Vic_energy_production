...
```
no longer see the repeating pattern in time series plot. 
...
```
significant lag at pacf 1 still so try a p value of 2 -- dont increase p to much
...
m3.ts<-Plot_Model(diff.Data_ts_agg,1,"X",2,0,2,2,1,0)
```
