...
adf.test(res.m4)
```
It can be seen the residuals are not stationary for the model 4 residuals so first differencing will be applied to the ARIMA model too.
...
# SARIMA(4,1,0)x(0,1,3)_12
# SARIMA(4,1,3)x(0,1,3)_12
# SARIMA(2,1,3)x(0,1,3)_12
# SARIMA(0,1,0)x(0,1,3)_12
# SARIMA(0,1,1)x(0,1,3)_12
# SARIMA(1,1,1)x(0,1,3)_12
# SARIMA(1,1,0)x(0,1,3)_12
