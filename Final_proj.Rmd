...
# ACF and PACF
par(mfrow=c(1,2))
acf(Data_ts_agg, main="Figure X: ACF plot of \ndaily Victorian electricity \nconsumption time series")
pacf(Data_ts_agg, main="Figure X: PACF plot of \ndaily Victorian electricity \nconsumption time series")
...
m1.ts = Arima(diff.Data_ts_agg,order=c(0,0,0),seasonal=list(order=c(0,1,0), period=6))
res.m1 = residuals(m1.ts);  
par(mfrow=c(1,1))
plot(res.m1,xlab='Time',ylab='Residuals',main="Figue X: Time series plot of model 1 residuals")
```
...
par(mfrow=c(1,2))
acf(diff.Data_ts_agg, main="Figure X: ACF plot of model 1 residuals")
pacf(diff.Data_ts_agg, main="Figure X: PACF plot of model 1 residuals")
```
