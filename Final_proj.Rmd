...
```
It can be seen on the ADF test above, the p-value of 0.3 is greater than 0.3 and therefore the null hypothesis cannot be rejected and the m4.ts isnt stationary.
...
# SARIMA(1,1,1)x(0,1,3)_12
# ML METHOD 
base_111_ML <- Parameter.estimation(Data_ts_agg,c(1,1,1),c(0,1,3),method="ML")
...
```{r}
# CSS METHOD 
base_111_CSS <- Parameter.estimation(Data_ts_agg,c(1,1,1),c(0,1,3),method="CSS")
...
# SARIMA(1,1,2)x(0,1,3)_12
# ML METHOD 
base_112_ML <- Parameter.estimation(Data_ts_agg,c(1,1,2),c(0,1,3),method="ML")
...
# SARIMA(2,1,1)x(0,1,3)_12
# ML METHOD 
base_211_ML <- Parameter.estimation(Data_ts_agg,c(2,1,1),c(0,1,3),method="ML")
...
# SARIMA(2,1,1)x(0,1,3)_12
# CSS METHOD 
base_211_CSS <- Parameter.estimation(Data_ts_agg,c(2,1,1),c(0,1,3),method="CSS")

```
- not normal 
- 1 significant lag in acf
- 4 significant parameters - 2 insignificant parameters
```{r}
# SARIMA(0,1,5)x(0,1,3)_12
base_015_ML <- Parameter.estimation(Data_ts_agg,c(0,1,5),c(0,1,3),method="ML")
```
- not normal 
- only 1 significant parameter
```{r}
# SARIMA(0,1,5)x(0,1,3)_12
base_015_CSS <- Parameter.estimation(Data_ts_agg,c(0,1,5),c(0,1,3),method="CSS")
```
- not normal 
...
```{r}
# SARIMA(0,1,2)x(0,1,3)_12
base_012_ML <- Parameter.estimation(Data_ts_agg,c(0,1,2),c(0,1,3),method="ML")
```
- not normal 
- only 1 significant parameter
```{r}
# SARIMA(0,1,2)x(0,1,3)_12
base_012_CSS <- Parameter.estimation(Data_ts_agg,c(0,1,2),c(0,1,3),method="CSS")
```
- not normal 
- only 2 significant parameters
```{r}
# SARIMA(0,1,3)x(0,1,3)_12
base_013_ML <- Parameter.estimation(Data_ts_agg,c(0,1,3),c(0,1,1),method="ML")
```
- not normal 
...
```{r}
# SARIMA(0,1,3)x(0,1,3)_12
base_013_ML <- Parameter.estimation(Data_ts_agg,c(0,1,3),c(0,1,3),method="CSS")
``- not normal 
- only 2 significant parameters`
