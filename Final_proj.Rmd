...
To deal with the season trend effect, we will fit an intial plain model (model 1) with the first seasonal difference to see if the seasonal trend is affected and to what extent. 
